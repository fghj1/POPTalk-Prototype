...
#define __WIN_ADAPTER_H__
		...
		{
			typedef CB2<O, U, bool, HWND, LPARAM> adapter_t;
		...
		{
			typedef CB2<O, U, bool, LPTSTR, LPARAM> adapter_t;
		...
		{
			typedef CB3<O, U, bool, HMODULE, LPTSTR, LONG_PTR> adapter_t;
		...
		{
			typedef CB4<O, U, bool, HMODULE, LPCTSTR, LPTSTR, LONG_PTR> adapter_t;
		...
		{
			typedef CB5<O, U, bool, HMODULE, LPCTSTR, LPCTSTR, WORD, LONG_PTR> adapter_t;
		...
		{
			typedef CB4<O, U, int, CONST LOGFONT*, CONST TEXTMETRIC*, DWORD, LPARAM> adapter_t;
		...
		{
			typedef CB4<O, U, int, ENUMLOGFONTEX*, NEWTEXTMETRICEX*, DWORD, LPARAM> adapter_t;
		...
		{
			typedef CB5<O, U, int, HDC, HANDLETABLE*, METARECORD*, int, LPARAM> adapter_t;
		...
		{
			typedef CB5<O, U, int, HDC, HANDLETABLE*, CONST ENHMETARECORD*, int, LPARAM> adapter_t;
		...
		{
			typedef CB2<O, U, int, LPTSTR, LPARAM> adapter_t;
		...
		{
			typedef CB2<O, U, int, LPVOID, LPARAM> adapter_t;
		...
		{
			typedef CB4< O, U, bool, PSTR, ULONG, ULONG, PVOID> adapter_t;
		...
		{
			typedef CB4<O, U, bool, HMONITOR, HDC, LPRECT, LPARAM> adapter_t;
		...
		HANDLE CreateThreadEx( O* obj, DWORD (O::*pfThreadStart)(U), U UserData = U(), PDWORD pThreadId = NULL, DWORD dwCreationFlags = 0,  DWORD dwStackSize = 0, PSECURITY_ATTRIBUTES pSA = NULL )
		{
			typedef HeapCB1<O, U, DWORD, LPVOID> adapter_t;
			DWORD dwDummy;
